...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 12 2023 г., 01:56
...
INSERT INTO `orders` (`id_order`, `id_user`, `date_time`) VALUES
(11, 1, '2023-06-12 02:54:36');
...
--
ALTER TABLE `cart`
  MODIFY `id_cart` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users_meduza` (`id_user`);
